...
import com.pcbtraining.pcb.databinding.FragmentCourseDiagramBinding
...
class CourseDiagramFragment : Fragment() {

    private lateinit var binding: FragmentCourseDiagramBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCourseDiagramBinding.inflate(inflater, container, false)
        val root: View = binding.root
        val loadingDialog = LoadingDialog(requireContext())

        loadingDialog.show()

        recyclerView = root.findViewById(R.id.diagrecycler)
        ...
        GlobalScope.launch(Dispatchers.Main) {
            try {
                val result = apiService.getDiagrams()
