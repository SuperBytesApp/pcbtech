...
class SensorValueFragment : Fragment() {

    private lateinit var binding: FragmentSensorValueBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSensorValueBinding.inflate(inflater, container, false)
        val root: View = binding.root
        val loadingDialog = LoadingDialog(requireContext())

        loadingDialog.show()

        recyclerView = root.findViewById(R.id.svaluerecycler)
        ...
        GlobalScope.launch(Dispatchers.Main) {
            try {
                val result = apiService.getSensorvalue()
