...
class AllDiagrampdfActivity : AppCompatActivity() {

    private lateinit var linksAdapter: DiagramAdapterr
    lateinit var binding : ActivityAllDiagrampdfBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityAllDiagrampdfBinding.inflate(layoutInflater)
...
//
        ...
        val targetFragment = CourseDiagramFragment()
        // Replace the current fragment with the target fragment
        transaction.replace(R.id.diafrag, targetFragment)
