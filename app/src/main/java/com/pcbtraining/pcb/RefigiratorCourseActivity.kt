...
import com.pcbtraining.pcb.databinding.ActivityRefigiratorCourseBinding
...
class RefigiratorCourseActivity : AppCompatActivity() {

    lateinit var binding : ActivityRefigiratorCourseBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRefigiratorCourseBinding.inflate(layoutInflater)
    ...
    fun coursedb(uid: String){
        ...
        documentReference.set(data)
            ...
            .addOnFailureListener { e ->
                ...
                Toast.makeText(this@RefigiratorCourseActivity, e.localizedMessage, Toast.LENGTH_SHORT).show()
    ...
    private fun phonepeCall() {
        try {
            PhonePe.init(this@RefigiratorCourseActivity, PhonePeEnvironment.RELEASE, "M221LXTRKYPP1", "")
