...
class AddSoftwareActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        webView.webChromeClient = object : WebChromeClient() {
            ...
            override fun onShowFileChooser(
                ...
                this@AddSoftwareActivity.filePathCallback = filePathCallback
                val intent = Intent(Intent.ACTION_GET_CONTENT).apply {
                    addCategory(Intent.CATEGORY_OPENABLE)
                    type = "*/*"
                }
                startActivityForResult(intent, AddSoftwareActivity.FILE_UPLOAD_REQUEST_CODE)
                return true
            }
        }
        ...
        // Load a web page
        val url = "https://pcbtech.in/course/supload.php"
        webView.loadUrl(url)
    }

    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        super.onActivityResult(requestCode, resultCode, data)
        if (requestCode == AddSoftwareActivity.FILE_UPLOAD_REQUEST_CODE) {
